...
\begin{table}
	...
	\begin{tabular}{| c | c | c | c | c | } \hline
		NGK & $ n $ & Precision & Recall & F1   \\ \hline	
		& 3 & 0.96 & 0.88 & 0.92     \\ 
...
\quad
	\subfloat[SSK performance for different sequence lengths $ n $. $ \lambda = 0.5 $ throughout.]{\begin{tabular}{| c | c | c | c | c | }\hline
			SSK & $ n $ & Precision & Recall & F1   \\ \hline	
			& 3 & 0.93 & 0.96 & 0.94     \\ 
...
\begin{table}
	...
	\end{tabular}
\caption{Lodhi et al.'s ten best performing classes with our results for WK, NGK and approximative SSK using the entire Reuters dataset. For aSSK; $ \lambda = 0.5 $\label{tab:full_data} }
\end{table}
